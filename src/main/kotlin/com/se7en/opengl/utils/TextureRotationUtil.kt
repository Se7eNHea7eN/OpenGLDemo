...
object TextureRotationUtil {
    ...
    fun getRotation(rotation: Int, flipHorizontal: Boolean,
                    flipVertical: Boolean): FloatArray {
        var rotatedTex: FloatArray
        when (rotation) {
            90 -> rotatedTex = TEXTURE_ROTATED_90
            180 -> rotatedTex = TEXTURE_ROTATED_180
            270 -> rotatedTex = TEXTURE_ROTATED_270
            0, 360 -> rotatedTex = TEXTURE_NO_ROTATION
